...
function PulseMark() {
  return <a href="/" className="flex items-center gap-2.5">
    ...
    <span className="font-display text-[1.42rem] font-semibold tracking-[-.04em]">Event<span className="text-[var(--pulse-coral)]">Pulse</span></span>
  </a>;
}
